...
namespace Game3
{
    class WaveManeger
    {
        ...
        public WaveManeger(Player player, Level level, int numberOfWaves, Texture2D[] enemyTexture, Texture2D healthTexture)
        {
            ...
            for (int i = 0; i < numberOfWaves; i++)
            {
                ...
                Wave wave = new Wave(i, initialNumerOfEnemies, player, level, enemyTexture, healthTexture);
                ;
